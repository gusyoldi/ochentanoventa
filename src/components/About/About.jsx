...
export default function About() {
  ...
  return (
    <div className={Styles.container}>
      ...
      <p>
        Somos una banda de Buenos Aires que versiona canciones de rock nacional
        en formato country, blues y rock and roll para traer a la actualidad
        canciones que nos marcaron en los años achenta y noventa.
      </p>
