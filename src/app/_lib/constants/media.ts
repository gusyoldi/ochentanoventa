...
export const VOLUMES_LIST: VolumeType[] = [
  {
    ...
    title: 'Qué ves?',
    spotifyUrl: 'https://open.spotify.com/album/1MIMo5mk1FQOFYYMGqlPsQ',
  ...
  },
  {
    ...
    title: 'Rezo por vos',
    spotifyUrl: 'https://open.spotify.com/album/50SBAlx7ky2f3Xj8vErLPL',
    year: '2023',
    format: 'Single',
  },
  {
    ...
    title: 'Sin cadenas',
    spotifyUrl: 'https://open.spotify.com/album/5tDFDAJiK2QlX1g5zdVU1l',
    year: '2023',
    format: 'Single',
  },
  {
    ...
    spotifyUrl: 'https://open.spotify.com/album/4zcjeynvwt24oj49Myf7Iu',
    year: '2023',
    format: 'Single',
  },
  {
    ...
    title: 'Volumen 2',
    spotifyUrl: 'https://open.spotify.com/album/2j2siXztKMfokm0MbhMSEX',
    year: '2022',
  ...
  },
  {
    ...
    title: 'Volumen 1',
    spotifyUrl: 'https://open.spotify.com/album/3RTbg6nammKOXbEFgJmBf8',
    year: '2021',
    songs: [
...
export const CAROUSEL_2_IMG: Image[] = [
  {
    src: '/images/carousel2/foto1.webp',
    alt: 'Banda Ochenta Noventa en vivo - Primer plano cantante',
  },
  {
    src: '/images/carousel2/foto2.webp',
    alt: 'Integrantes de Ochenta Noventa con instrumentos acústicos',
  },
  {
    src: '/images/carousel2/foto3.webp',
    alt: 'Show en vivo de Ochenta Noventa en evento corporativo',
  },
  {
    src: '/images/carousel2/foto4.webp',
    alt: 'Banda Ochenta Noventa tocando clásicos del rock',
  },
];

export const CAROUSEL_3_IMG: Image[] = [
  {
